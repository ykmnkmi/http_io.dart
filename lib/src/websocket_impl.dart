...
class _WebSocketProtocolTransformer extends StreamTransformerBase<List<int>,
  ...
  static const int lenFirst = 1;
  static const int lenRest = 2;
  ...
  Stream<dynamic /*List<int>|_WebSocketPing|_WebSocketPong*/ > bind(
    ...
    return Stream.eventTransformed(stream, (EventSink<dynamic> eventSink) {
      if (_eventSink != null) {
...
typedef _ProtocolSelector = /*String|Future<String>*/ Object Function(
...
class _WebSocketTransformerImpl
  ...
  static _WebSocketPerMessageDeflate? _negotiateCompression(HttpRequest request,
    ...
    if (compression.enabled && hv.value == _WebSocketImpl.perMessageDeflate) {
...
class _WebSocketConsumer implements StreamConsumer<dynamic> {
  ...
  Completer<_WebSocketImpl>? _completer;
...
class _WebSocketImpl extends Stream<dynamic>
    with _ServiceObject
  ...
  static Future<WebSocket> connect(
    ...
    var callerStackTrace = StackTrace.current;
  ...
  static _WebSocketPerMessageDeflate? negotiateClientCompression(
    ...
    if (compression.enabled && hv.value == perMessageDeflate) {
      var serverNoContextTakeover =
          hv.parameters.containsKey(_serverNoContextTakeover);
      var clientNoContextTakeover =
          hv.parameters.containsKey(_clientNoContextTakeover);
      ...
      int getWindowBits(String type) {
        ...
        return int.tryParse(o) ?? defaultWindowBits;
      }
  ...
  @override
  StreamSubscription<dynamic> listen(void Function(dynamic message)? onData,
