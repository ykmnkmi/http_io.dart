...
StreamTransformer<Object, Object> createReverseStringTransformer() {
  return StreamTransformer<Object, Object>.fromHandlers(
    handleData: (data, sink) {
      var sb = StringBuffer();
      for (int i = (data as String).length - 1; i >= 0; i--) sb.write(data[i]);
